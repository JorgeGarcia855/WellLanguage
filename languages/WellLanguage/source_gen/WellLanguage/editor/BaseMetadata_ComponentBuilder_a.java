...
/*package*/ class BaseMetadata_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BaseMetadata_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jclcww_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_jclcww_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("BM_property_name");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_jclcww_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new metadataSingleRoleHandler_jclcww_c0(myNode, LINKS.metadata$bI1o, getEditorContext());
    return provider.createCell();
  }
  private static class metadataSingleRoleHandler_jclcww_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public metadataSingleRoleHandler_jclcww_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_jclcww_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
