...
/*package*/ class FluidTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FluidTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_730v78_a");
  ...
  private EditorCell createTable_0(final EditorContext editorContext, final SNode node) {
    ...
    _FunctionTypes._void_P0_E0 creator = () -> EditorCacheHacks.noCaching(editorContext, () -> {
      try {
        ...
        final Grid childGrid = createChildsVertical_730v78_a1a(editorContext, node);
        ...
        editorCell.value.setCellId("Table_730v78_b0");
  ...
  public Grid createChildsVertical_730v78_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_730v78_a0b0(editorContext, node));
    grid.setRowHeaders(0, 0, createHeadQuery_730v78_a0b0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.fluids$4VZX)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.fluids$4VZX);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).getElement(y) : null), LINKS.fluids$4VZX);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).isEmpty()) {
      EditorCell placeholder = new EditorCellFactory(editorContext, node, grid).createPlaceholderConstant("<no fluids>");
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.fluids$4VZX, editorContext);
  ...
  public HeaderGrid createHeaderCollection_730v78_a0b0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_730v78_a0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_b0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_c0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_d0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_e0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_f0a1a(editorContext, node));
    nodeList.add(createStaticHeader_730v78_g0a1a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_730v78_a0a1a(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_730v78_b0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_730v78_c0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_730v78_d0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_730v78_e0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_730v78_f0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_730v78_g0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createHeadQuery_730v78_a0b0(final EditorContext editorContext, final SNode node) {
    Object queryResult = new Object() {
      public Object query() {
        return ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).select((it) -> Integer.toString(SNodeOperations.getIndexInParent(it) + 1));
      }
    }.query();
    IHeaderNodeInsertAction insertAction = new IHeaderNodeInsertAction() {
      public void insertNew(int index) {
        SNodeFactoryOperations.addNewChild(node, LINKS.fluids$4VZX, null);
      }
    };
    IHeaderNodeDeleteAction deleteAction = new IHeaderNodeDeleteAction() {
      public void delete(final int index) {
        if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).count() > 1) {
          ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.fluids$4VZX)).removeElementAt(index);
        }
      }
    };
    HeaderGrid grid = new HeaderGridFactory(editorContext, node, false).createFromObject(queryResult, new StringHeaderReference("6497204669838158024"), insertAction, deleteAction, 0, new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
        return style;
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink fluids$4VZX = MetaAdapterFactory.getContainmentLink(0x1f9e61a5590e4e5eL, 0x9835cf0a05fde422L, 0x5a2ab5393ab6687eL, 0x5a2ab5393ab6687fL, "fluids");
  }
}
