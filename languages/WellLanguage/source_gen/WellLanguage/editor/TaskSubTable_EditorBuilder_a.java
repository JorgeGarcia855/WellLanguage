...
/*package*/ class TaskSubTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TaskSubTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createTable_0(final EditorContext editorContext, final SNode node) {
    ...
    _FunctionTypes._void_P0_E0 creator = () -> EditorCacheHacks.noCaching(editorContext, () -> {
      try {
        ...
        final Grid childGrid = createChildsVertical_8zgscs_a0(editorContext, node);
        ...
        editorCell.value.setCellId("Table_8zgscs_a");
  ...
  public Grid createChildsVertical_8zgscs_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_8zgscs_a0a(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.tasks$l1GX)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.tasks$l1GX);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tasks$l1GX)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tasks$l1GX)).getElement(y) : null), LINKS.tasks$l1GX);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tasks$l1GX)).isEmpty()) {
      EditorCell placeholder = new EditorCellFactory(editorContext, node, grid).createPlaceholderConstant("<no tasks>");
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.tasks$l1GX, editorContext);
  ...
  public HeaderGrid createHeaderCollection_8zgscs_a0a(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_8zgscs_a0a0(editorContext, node));
    nodeList.add(createStaticHeader_8zgscs_b0a0(editorContext, node));
    nodeList.add(createStaticHeader_8zgscs_c0a0(editorContext, node));
    nodeList.add(createStaticHeader_8zgscs_d0a0(editorContext, node));
    nodeList.add(createStaticHeader_8zgscs_e0a0(editorContext, node));
    nodeList.add(createStaticHeader_8zgscs_f0a0(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_8zgscs_a0a0(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Task", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Task"), cell);
    header.setLabel("Task");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_8zgscs_b0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_8zgscs_c0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_8zgscs_d0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Start Date", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Start Date"), cell);
    header.setLabel("Start Date");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_8zgscs_e0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "End Date", false);
    Header header = new EditorCellHeader(new StringHeaderReference("End Date"), cell);
    header.setLabel("End Date");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_8zgscs_f0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
